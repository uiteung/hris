...
fetch(`https://hris_backend.ulbi.ac.id/pegawai/sdm/byid/${idSdm}`, requestOptions)
	...
	.then((objectData) => {
            ...
            <div class="card mb-3">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">${objectData.data.nama}</div>
                </div>
                <hr />
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">${objectData.data.jenis_kelamin}</div>
                </div>
                <hr />
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">${objectData.data.tempat_lahir}</div>
                </div>
                <hr />
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">${objectData.data.tanggal_lahir}</div>
                </div>
				<hr />
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9 text-secondary">${objectData.data.nama_ibu_kandung}</div>
                </div>
              </div>
            </div>
            <div class="row gutters-sm">
		...
		document.getElementById("card-body").innerHTML = divData;
	})
	.catch(error => {
